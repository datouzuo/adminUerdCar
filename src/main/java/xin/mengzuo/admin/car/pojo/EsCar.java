...
public class EsCar {
    ...
    private String rangeDisplacment;
	...
	public String getRangeDisplacment() {
		return rangeDisplacment;
	}
	public void setRangeDisplacment(String rangeDisplacment) {
		this.rangeDisplacment = rangeDisplacment;
	}
